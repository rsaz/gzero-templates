...
A production-minded TypeScript API with one endpoint, built on NestJS 11 and its Express adapter.
...
Build and run the container with `docker build -t gzero-api-nestjs .` and `docker run --rm -p 3000:3000 gzero-api-nestjs`.
