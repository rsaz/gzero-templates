...
A production-minded TypeScript API with one endpoint, built on Koa 3.
...
Build and run the container with `docker build -t gzero-api-koa .` and `docker run --rm -p 3000:3000 gzero-api-koa`.
